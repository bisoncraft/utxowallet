...
[![GoDoc](https://godoc.org/github.com/bisoncraft/utxowallet/walletdb?status.png)]
(http://godoc.org/github.com/bisoncraft/utxowallet/walletdb)
...
http://localhost:6060/pkg/github.com/bisoncraft/utxowallet/walletdb

## Installation

```bash
$ go get github.com/bisoncraft/utxowallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/bisoncraft/utxowallet/walletdb#example-package--BasicUsage)  
